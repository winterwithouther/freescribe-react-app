...
export default function HomePage(props) {
  ...
  return (
    ...
    pb-20'>
      <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Free<span className='text-blue-400 bold '>Sribe</span></h1>
      ...
      Translate <span className='text-blue-400'>&rarr;</span> </h3>
      <button onClick={recordingStatus === "recording" ? stopRecording : startRecording} className='flex items-center text-base justify-between gap-4 mx-auto w-72 max-w-full
      my-4 special-button px-4 py-2 rounded-xl'>
